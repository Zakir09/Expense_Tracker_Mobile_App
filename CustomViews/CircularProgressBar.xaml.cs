namespace ExpenseTracker.CustomViews;
...
public partial class CircularProgressBar : ContentView
{
	...
	public static readonly BindableProperty BudgetProperty = BindableProperty.Create(nameof(Budget), typeof(int), typeof(CircularProgressBar));
	...
	public static readonly BindableProperty BudgetColorProperty = BindableProperty.Create(nameof(BudgetColor), typeof(Color), typeof(CircularProgressBar));
	...
	public int Budget
	{
		get { return (int)GetValue(BudgetProperty); }
